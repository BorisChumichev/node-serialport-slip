...
describe('SLIPMessage class', function () {
  ...
  it('instantiates a SLIP escaped message', function () {
    var initialBuffer = new Buffer([0x35, 0xA1, 0xBC, 0xC0, 0x12, 0xC1, 0xDB, 0xAA, 0x11, 0xDB])
      , expectedBuffer = new Buffer([0x35, 0xA1, 0xBC, 0xDB, 0xDC, 0x12, 0xC1, 0xDB, 0xDD, 0xAA, 0x11, 0xDB, 0xDD])
